const validation = ({ name, summary, healthScore, steps, image, diets }, recipe) => {
    ...
    if (!summary) {
      ...
      errors.summary = "The summary can't be shorter than 50 characters";
    } else if (summary.length > 1500) {
      errors.summary = "The summary can't be longer than 1500 characters";
    }
    ...
    if (!image) {
      ...
      errors.image = "Image URL does not meet the requirements (JPG, JPEG, GIF, PNG, BMP)";
    }
